...
include::clause-5-requirements.adoc[]

include::clause-6-recommendations.adoc[]

////
add major sections (clauses) as necessary
make a copy of clause-7-example.adoc and label it as follows
////

include::clause-7-example.adoc[]
